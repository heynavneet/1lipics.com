    ...
    if ($count == 1) {
    	...
    	require 'PHPMailer/PHPMailerAutoload.php';         		// Send Password to user Email By PHPMailer
			...
			$mail->Body    = "<div style='text-align: center;' >
             ...
             <div>
			  <a href='https://1lipics.com/reset.php?id=$id&token=$token'>https://1lipics.com/reset.php?id=$id&token=$token</a> 
			  </div> 
			  <div style='text-align: center; margin-top: 5px; font-size: 18px;'>
             <a href='https://1lipics.com/reset.php?id=$id&token=$token'> Reset Password </a>
             </div>";
